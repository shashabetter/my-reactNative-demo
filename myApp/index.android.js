...
import {Platform,Image,ScrollView,StatusBar,StyleSheet,Text,TouchableHighlight,View,AppRegistry} from 'react-native';
...
class myApp extends Component{
  constructor(props){
    ...
    render(){
      const slide=this.state.weather.map((elem,index)=>{
